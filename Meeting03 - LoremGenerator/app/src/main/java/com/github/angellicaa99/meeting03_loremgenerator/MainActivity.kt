...
import com.github.angellicaa99.meeting03_loremgenerator.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val strawberryIpsum: Ipsum = Ipsum("strawberry Ipsum", "I love cheese, especially goat macaroni cheese. Danish fontina pecorino bocconcini stinking bishop port-salut cheesy feet blue castello red leicester. Caerphilly smelly cheese dolcelatte edam port-salut hard cheese fromage frais rubber cheese. Everyone loves cheddar airedale fromage frais fromage frais st. agur blue cheese swiss croque monsieur. Monterey jack pepper jack.\n" +
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.strawberryIpsum = strawberryIpsum
        binding.orangeIpsum = orangeIpsum
        binding.watermelonIpsum = watermelonIpsum
        ...
        binding.loremTypeSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                when (currentType) {
                    ...
                    "strawberry Ipsum" -> {
                        binding.titleText.text = strawberryIpsum.type
                        binding.loremText.text = strawberryIpsum.content
                    }
                    "orange Ipsum" -> {
                        binding.titleText.text = orangeIpsum.type
                        binding.loremText.text = orangeIpsum.content
                    }
                    "watermelon Ipsum" -> {
                        binding.titleText.text = watermelonIpsum.type
                        binding.loremText.text = watermelonIpsum.content
                    }
                }
            }
